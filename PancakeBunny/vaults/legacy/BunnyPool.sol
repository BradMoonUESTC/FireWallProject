...
contract BunnyPool is IStrategyLegacy, RewardsDistributionRecipient, ReentrancyGuard, Pausable {
    ...
    IBEP20 public constant stakingToken = IBEP20(0x1870695A97B0e157511DDD3Af9277CA6695A6C7f);   // bunny
    ...
    /* ========== BUNNY HELPER ========= */
    IStrategyHelper public helper = IStrategyHelper(0xeDd7C72bb4b788fa89973d4D9f8b560C0A05940E);
