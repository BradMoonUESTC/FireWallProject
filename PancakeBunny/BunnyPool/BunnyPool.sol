...
contract BunnyPool is IStrategyLegacy, RewardsDistributionRecipient, ReentrancyGuard, Pausable {
    ...
    IBEP20 public constant stakingToken = IBEP20(0xA6D8F2C13bCF110Bb6A4bC6106B91924DC6af377);   // bunny
    ...
    /* ========== BUNNY HELPER ========= */
    IStrategyHelper public helper = IStrategyHelper(0xC2DBaA27e5122A35D0Dc09061806ECEc614B94Df);
